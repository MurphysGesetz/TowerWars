...
public class PathFinderGoalAttacker extends PathfinderGoal {
    ...
    public PathFinderGoalAttacker(EntityInsentient entityInsentient, Location targetLocation, float speed, TowerWarsTeam towerWarsTeam, TowerWarsTeam attackerTowerWarsTeam, Location[] path, float[] move) {

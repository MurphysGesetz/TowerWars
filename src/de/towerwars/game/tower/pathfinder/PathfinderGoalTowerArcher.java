...
public class PathfinderGoalTowerArcher extends PathfinderGoal {
    ...
    public PathfinderGoalTowerArcher(ModuleManager moduleManager, EntityInsentient entityInsentient, int damage, int range, int shootdelay, Player towerPlacer) {
